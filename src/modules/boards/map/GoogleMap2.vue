<template>
  <div id="root">
    ...
    <GmapMap ref="mapRef" :center="center" :zoom="9" style="height: 900px">
      ...
      <gmap-marker :key="index" v-for="(m, index) in markers" :position="m.position" :label="m.label" :clickable="true" :draggable="false" @click="toggleInfoWindow(m,index)" @mouseover="statusText = m.text" @mouseout="statusText = null"></gmap-marker>
      <div slot="visible">
